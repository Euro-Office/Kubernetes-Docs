...
| `customResources.job.annotations`                           | Defines annotations that will be additionally added to Custom Resources Job. If set to, it takes priority over the `commonAnnotations`                                         | `{}`                                                                                      |
| `customResources.job.podAnnotations`                        | Map of annotations to add to the Custom Resources Pod                                                                                                                          | `{}`                                                                                      |
| `customResources.job.customPodAntiAffinity`                 | Prohibiting the scheduling of Custom Resources Job Pod relative to other Pods containing the specified labels on the same node                                                 | `{}`                                                                                      |
| `customResources.job.podAffinity`                           | Defines [Pod affinity](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#inter-pod-affinity-and-anti-affinity) rules for Custom Resources Job Pod scheduling by nodes relative to other Pods | `{}`                                                 |
| `customResources.job.nodeAffinity`                          | Defines [Node affinity](https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#node-affinity) rules for Custom Resources Job Pod scheduling by nodes         | `{}`                                                                                      |
